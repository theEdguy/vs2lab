...
from time import sleep #für sleep
import threading  #für thread
...
class Client:
    ...
    #callback hinzugefügt als optionale parameter
    def append(self, data, db_list, callback=None):
        assert isinstance(db_list, DBList)
        msglst = (constRPC.APPEND, data, db_list)  # message payload
        self.chan.send_to(self.server, msglst)  # send msg to server

        #logic verändern -> ack empfangen ->
        ...
        while True:
            ...
            if msgreq is not None:
                ...
                if constRPC.APPEND == msgrpc[0]:  # check what is being requested
                    ...
                    self.chan.send_to(msgreq[0], ("RESULT", result))  # return response
                else:
